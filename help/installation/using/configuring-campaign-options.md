...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> <span class="uicontrol">NmsNPAI_MobileInvergityErrorDelay</span><br /> </td> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> （安裝相容模式：build&gt;6000）如果輸入"1"，此選項將激活儲存密碼的相容模式。 更改此選項可防止使用儲存在資料庫中的舊密碼。<br /> </td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> <span class="uicontrol">NmsCleanup_CompositionPurgeDelay</span><br /> </td> 
