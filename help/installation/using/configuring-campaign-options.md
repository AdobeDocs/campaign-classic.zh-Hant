...
**[!UICONTROL Administration / Platform / Options]**&#x200B;節點可讓您設定Adobe Campaign選項。 其中有些是內建在安裝Campaign時，有些則可視需要手動新增。 可用選項會因您執行個體所安裝的套件而異。


>[!CAUTION]
>
>* 此頁面中未列出的選項僅供內部使用，**不可修改**。
>
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> 上次從傳遞性執行個體擷取的broadLogMsg日期。<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">Deliverability_LastBroadLogMsgSent</span> <br /> </td> 
   <td> 最後傳送至傳遞性執行個體的broadLogMsg日期。<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">DmRendering_cuid</span> <br /> </td> 
   <td> 傳遞報告識別碼。 請連絡支援以取得您的識別碼。<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 傳遞準備期間插入broadLogs的最小批次大小（列數）。<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsBroadcast_MaxDelayPerTransac</span> <br /> </td> 
   <td> 批次持續時間臨界值（毫秒數），在傳遞準備期間插入broadLogs的批次大小會加倍。<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 可讓您定義傳送訊息時使用的寄件者地址的語法。<br /> </td> 
  </tr> 
  <tr> 
 ...
 <tr> 
   ...
   <td> 可讓您定義從個人化URL下載並附加至電子郵件的影像允許的大小上限（以位元組為單位）。 預設值為100,000位元組(100 KB)。 傳送校樣並下載影像以處理電子郵件時，如果影像大小超過此值或發生下載問題，傳送記錄中將會顯示錯誤，且校樣傳送將會失敗。<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 使用者留空時，在執行個體用於電子郵件傳遞的層級預設「寄件者」電子郵件標籤。<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsEmail_ReplyToName</span> <br /> </td> 
   <td> 使用者留空時，在執行個體用於電子郵件傳遞的層級預設「回覆」電子郵件標籤。<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 'lineImage' servlet中用來編碼URL （LINE管道）的AES金鑰。<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsNPAI_EmailMaxError</span> <br /> </td> 
   <td> 在頻道「電子郵件」（使用作為預設值） ：在傳送期間的SOFT錯誤，在讓收件者進入隔離之前可以接受的最大錯誤數量。<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 在頻道「行動」上：在傳送期間發生SOFT錯誤，將收件者放入隔離之前，可接受的最大錯誤數量。<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsNPAI_MobileSignalErrorDelay</span> <br /> </td> 
   <td> 在頻道「行動」上：計及新的SOFT錯誤之前，自先前參考的SOFT錯誤以來的最短逗留時間。<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> MidSourcing工作階段中可並行執行的最大呼叫數（預設為3）。<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsMTA_Alert_Delay</span> <br /> </td> 
   <td> 自訂延遲（以分鐘為單位），過了此延遲後，傳遞會視為「延遲」，預設為30分鐘。<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 已傳送SMS訊息的引數：傳送至SMS閘道的資訊，以指示訊息優先順序。<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <span class="uicontrol">NmsUserAgent</span>統計資料的上次合併日期。<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 使用「0」值新增此選項，以停用傳遞的XML程式碼版本（按一下滑鼠右鍵/<span class="uicontrol">編輯XML來源</span>或<span class="uicontrol">CTRL + F4</span>捷徑）。<br /> </td> 
  </tr>  
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> 在Adobe Campaign使用者端主控台中發佈的資源位置。 請參閱<a href="../../delivery/using/formatting.md#image-referencing">此節</a>.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NcmResourcesDirPreview</span> <br /> </td> 
   <td> 在Adobe Campaign使用者端主控台中預覽的資源位置。 請參閱<a href="../../delivery/using/formatting.md#image-referencing">此節</a>.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsDelivery_DefaultIgnoredImage</span> <br /> </td> 
   <td> 上傳期間略過的影像URL遮罩清單。<br /> </td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 由operationMgt工作流程啟動的傳遞/工作流程/假設/模擬工作數上限。<br /> </td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> （自21.1.3發行版本開始）如果選取1 （預設值），此選項會停用內建結構描述的版本。<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">RestrictEditingOOTBJavascript</span> <br /> </td> 
   <td> （自21.1.3發行版本開始）如果選取1 （預設值），此選項會停用內建的JavaScript程式碼版本。<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">XtkAcceptOldPasswords</span> <br /> </td> 
   <td> （安裝相容性模式： build&gt;6000）啟動時（值「1」），此選項允許使用儲存在資料庫中的舊密碼來連線到外部帳戶或執行個體。<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 如果選取1，此選項會在檔案下載期間停用ACL控制項（透過fileDownload.jsp）。<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 若設為'true'，授權的非管理員操作員會透過部署精靈更新xtkOption值。<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 輸入「1」值，在刪除記錄之前，透過修改其「修改者」欄位，追蹤mData中具有「稽核軌跡」資訊之元素的刪除。<br /> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> JavaScript資料庫將個人化，以豐富活動內容。 必須包含這兩個函式的實作： <br /> 
    <ul> 
     <li> <p> <span class="uicontrol">extendedRtEvents(aiEventId)；</span> ：豐富並儲存資料庫中的事件（其中<span class="uicontrol">aiEventId</span>對應到已處理的即時事件表格）。</p> </li> 
     <li> <p> <span class="uicontrol">extendedBatchEvents(aiEventId)；</span> ：擴充並儲存資料庫中的事件（其中<span class="uicontrol">aiEventId</span>對應至已處理批次事件的ID表格）。</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 將針對路由事件個人化的JavaScript資料庫。 必須包含這兩個函式的實作： <br /> 
    <ul> 
     <li> <p> <span class="uicontrol">dispatchRtEvent(iEventId)；</span> ：傳回選取用來處理即時事件的交易式訊息的內部名稱（其中<span class="uicontrol">iEventId</span>對應到處理之即時事件的識別碼）。</p> </li> 
     <li> <p> <span class="uicontrol">dispatchBatchEvent(iEventId)；</span> ：傳回選取用來處理批次事件的交易式訊息的內部名稱（其中<span class="uicontrol">iEventId</span>對應到已處理批次事件的ID）。</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 待處理即時事件佇列的嚴重狀況之前的臨界值。<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">MC_RtEventQueueWarning</span> <br /> </td> 
   <td> 待處理即時事件佇列警告前的臨界值。<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 用來傳送歡迎訊息的Message Center伺服器URL （LINE通道）。<br /> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 用來包含Adobe Campaign ootb表格資料的表格空間名稱。<br />請參閱<a href="../../installation/using/creating-and-configuring-the-database.md">建立和設定資料庫</a>。</td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">WdbcOptions_TableSpaceIndex</span> <br /> </td> 
   <td> 用來包含Adobe Campaign ootb表格索引的表格空間名稱。<br />請參閱<a href="../../installation/using/creating-and-configuring-the-database.md">建立和設定資料庫</a>。</td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">WdbcOptions_TableSpaceWork</span> <br /> </td> 
   <td> 用來包含Adobe Campaign工作表資料的表格空間名稱。<br />請參閱<a href="../../installation/using/creating-and-configuring-the-database.md">建立和設定資料庫</a>。</td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">WdbcOptions_TableSpaceWorkIndex</span> <br /> </td> 
   <td> 用來包含Adobe Campaign工作表索引的表格空間名稱。<br />請參閱<a href="../../installation/using/creating-and-configuring-the-database.md">建立和設定資料庫</a>。</td> 
  </tr> 
    <tr> 
   <td> <span class="uicontrol">WdbcOptions_TempDbName</span> <br /> </td> 
   <td> 可讓您為Microsoft SQL Server上的工作表格設定個別的資料庫，以最佳化備份與復寫。 選項與暫存資料庫的名稱相對應：如果指定，會將工作表寫入此資料庫。 範例： 'tempdb.dbo.' （請注意，名稱必須以點結尾）。 <a href="../../production/using/rdbms-specific-recommendations.md#microsoft-sql-server">閱讀更多資訊</a> <br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">WdbcTimeZone</span> <br /> </td> 
   <td> Adobe Campaign例項的時區。 檢視<a href="../../installation/using/time-zone-management.md#configuration" target="_blank">組態</a>.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">WdbcUseNChar</span> <br /> </td> 
   <td> 資料庫的字串欄位是否以NChar定義？<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 查詢在xtk：schema和xtk：srcSchema上傳回的結果數目上限。<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 在移轉期間，樹狀結構會根據新版本標準自動重新組織。<br />此選項可讓您停用導覽樹狀結構的自動移轉。 如果使用它，移轉後您必須刪除過時的資料夾、新增資料夾並執行所有必要的檢查。<br /> 
    ...
    </ul> 只有在現成可用的導覽樹狀結構發生太多變更時，才應該使用此選項。<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsLastErrorStatCoalesce</span> <br /> </td> 
   <td> <span class="uicontrol">NmsEmailErrorStat</span>資料表清理的上次處理日期。<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">PostUpgradeLastError</span> <br /> </td> 
   <td> 依照下列語法，提供升級後發生錯誤的相關資訊：<br /> <strong>{Build number}：{mode： pre/post/...}：{發生錯誤的'lessThan'/'greaterOrEquelThan' +子步驟}</strong> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">XtkCleanup_NoStats</span> <br /> </td> 
   <td> 輸入「1」值，這樣統計資料的更新就不會透過清除工作流程執行。<br /> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 用來與Adobe Audience Manager整合的選項。<br /> </td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 可讓您在移轉後繼續使用舊的未宣告SQL函式。 我們強烈建議不要使用此選項，因為它會帶來安全性風險。<br /> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 指標會追蹤最後透過其ID和日期處理的訊息事件。<br /> </td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 處理/刪除隱私權要求時允許的錯誤數目上限。<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">Privacy_Request_PurgeDelay</span> <br /> </td> 
   <td> 已在佇列上建立請求之間的延遲，且已刪除請求資料。<br /> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 在Adobe Campaign中啟用自動建立操作者與許可權。<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">XtkLdap_DN</span> <br /> </td> 
   <td> 以登入為基礎的LDAP DN計算公式。<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 用來連絡LDAP伺服器的驗證型別(plain、md5、lds、ntlm、dpa)。<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">XtkLdap_Rights</span> <br /> </td> 
   <td> 啟用從LDAP目錄到Adobe Campaign中已命名許可權的授權和群組同步處理。<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 搜尋使用者授權的篩選器。<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">XtkLdap_RightsMask</span> <br /> </td> 
   <td> 從LDAP授權擷取Adobe Campaign許可權名稱的運算式。<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> LDAP伺服器位址（可以透過指定'：'做為分隔符號來指定連線埠）。<br /> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 要連絡以進行網頁表單失效的伺服器個人化位址清單（「其他伺服器」模式）。<br /> </td> 
  </tr> 
 </tbody> 
</table>
