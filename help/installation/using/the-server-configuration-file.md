...
# 伺服器配置檔案{#the-server-configuration-file}

Adobe Campaign的整體設定是在位於安裝目錄 **conf****** 目錄的serverConf.xml檔案中定義。 本節列出serverConf.xml檔案的所有不 **同節點和參數** 。

>[!NOTE]
>
>伺服器端組態只能由Adobe針對Adobe代管的部署執行。 若要進一步瞭解不同的部署，請參閱「代 [管模型](../../installation/using/hosting-models.md) 」一節或 [本文章](https://helpx.adobe.com/campaign/kb/acc-on-prem-vs-hosted.html)。 本節將介紹代管和混合機型的安裝和配置步 [驟](../../installation/using/hosted-model.md)。
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 傳送統計資料伺服器的位址，指定為&lt;dns或ip&gt; [: 
     &lt;port&gt; ]。 請參 <a href="../../installation/using/email-deliverability.md#coordinates-of-the-statistics-server" target="_blank">閱統計伺服器的坐標</a>。 
      <br /> 
     </td> 
   <td> 字串<br /> </td> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> publicId<br /> </td> 
   <td> 關聯的公用地址ID。 用作統計伺服器的密鑰。 必須是數值。 請參閱本 <a href="../../installation/using/email-deliverability.md#managing-ip-addresses">節</a>。<br /> </td> 
   <td> 長<br /> </td> 
  </tr> 
  <tr> 
   <td> 權重<br /> </td> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> 埠<br /> </td> 
   <td> 伺服器偵聽埠。 請參閱本 <a href="../../installation/using/email-deliverability.md#definition-of-the-server-port">節</a>。<br /> </td> 
   <td> 簡短<br /> </td> 
   <td> <br /> </td> 
  </tr> 
  <tr> 
