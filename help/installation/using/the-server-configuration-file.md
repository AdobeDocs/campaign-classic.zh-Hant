...
Adobe Campaign的整體組態定義於位於安裝目錄&#x200B;**conf**&#x200B;目錄的&#x200B;**serverConf.xml**&#x200B;檔案中。 本節列出&#x200B;**serverConf.xml**&#x200B;檔案的所有不同節點和引數。
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 長工作階段的逾時（以秒為單位）。<br /> </td> 
   <td> 長<br /> </td> 
   <td> 1296000<br /> </td> 
  </tr> 
  <tr> 
   <td> securityTimeOutSec<br /> </td> 
   <td> 安全性權杖逾時（以秒為單位）。<br /> </td> 
   <td> 長<br /> </td> 
   <td> 86400<br /> </td> 
  </tr> 
  <tr> 
...
以下是&#x200B;**dataStore**&#x200B;節點的不同引數。 這是定義伺服器資料來源的位置。
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 額外的沙箱目錄：要新增到沙箱中的其他路徑（以逗號分隔）。<br /> </td> 
   <td> 字串<br /> </td> 
  ...
  <tr> 
   ...
   <td> 互動JSSP快取到期延遲：快取專案失效後的逾時（以秒為單位）。 負值表示快取一律會失效。 '0'、空白或無效的值視為60。<br /> </td> 
   <td> 長<br /> </td> 
   <td> 300<br /> </td> 
  </tr> 
  <tr> 
   <td> lang<br /> </td> 
   <td> 例項語言（分項清單）。 可能的值包括'fr_FR' (Français)、'en_GB' (English (UK))、'en_US' (English (US))、'de_DE' (Deutsch)和'ja_JP' (Japanese)。<br /> </td> 
   <td> 字串<br /> </td> 
   <td> 'en_US'<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 要下載的已授權檔案，以「，」分隔。 字串必須是有效的規則Java運算式。 請參閱<a href="file-res-management.md" target="_blank">限制可上傳的檔案</a>.<br /> </td> 
   <td> 字串<br /> </td> 
   <td> '.+' <br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 檢視快取的有效期：快取專案失效後的逾時（以秒為單位）。 負值表示快取一律會失效。 '0'、空白或無效的值視為60。<br /> </td> 
   <td> 長<br /> </td> 
   <td> 600<br /> </td> 
  </tr> 
  <tr> 
...
以下是&#x200B;**dataStore > proxyAdjust**&#x200B;節點的不同引數。 根據urlBase中定義的URL重新產生符合規則運算式的URL。
...
以下是&#x200B;**dataStore > dataSource**&#x200B;節點的不同引數。
...
在&#x200B;**dataStore > dataSource > dbcnx**&#x200B;節點中，設定連線設定：
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 資料庫<br />中的Unicode資料 </td> 
   <td> 布林值<br /> </td> 
   <td> </td> 
  </tr> 
  <tr> 
   <td> useTimestampTZ<br /> </td> 
   <td> 日期欄位具有時區：請參閱<a href="../../installation/using/time-zone-management.md" target="_blank">時區管理</a>.<br /> </td> 
   <td> 布林值<br /> </td> 
   <td> </td> 
  </tr> 
 </tbody> 
...
在&#x200B;**dataStore > dataSource > sqlParams**&#x200B;節點中，設定SQL引數：
...
在&#x200B;**dataStore > dataSource > pool**&#x200B;節點中，設定關聯連線集區的引數：
...
以下是&#x200B;**dataStore > virtualDir**&#x200B;節點的不同引數。 這是虛擬目錄到真實目錄對應的組態。
...
以下是&#x200B;**dataStore > preprocessCommand**&#x200B;節點的不同引數。 這些是預先處理「載入檔案」工作流程活動的授權命令。
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> DNS伺服器：網域名稱伺服器(DNS)的逗號分隔清單。 請參閱下列備註。<br /> </td> 
   <td> 字串<br /> </td> 
   <td> <br /> </td> 
  </tr> 
  <tr> 
...
以下是&#x200B;**exec** （命令執行）節點的不同引數。

如需其他資訊，請參閱[限制授權的外部命令](../../installation/using/configuring-campaign-server.md#restricting-authorized-external-commands)。
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> 模式<br /> </td> 
   <td> 用於轉換的工具。 可能的值為： phantomjs、wkhtmltopdf、other、disabled<br /> </td> 
   <td> 字串<br /> </td> 
   <td> 'phantomjs' <br /> </td> 
  </tr> 
  <tr> 
   <td> 逾時<br /> </td> 
   <td> 轉換逾時：最長轉換時間（以秒為單位）。 超過此臨界值，轉換程式就會停止並引發錯誤。<br /> </td> 
   <td> 長<br /> </td> 
   <td> 120<br /> </td> 
  </tr> 
  <tr> 
...
以下是&#x200B;**ims**&#x200B;節點的不同引數。 這是Campaign使用[IMS](../../integrations/using/about-adobe-id.md)連線至其他服務的設定。
...
以下是&#x200B;**javaScript**&#x200B;節點的不同引數。 這是JavaScript解譯器的設定。

如需其他資訊，請參閱[報告檔案](../../reporting/using/actions-on-reports.md#memory-allocation)。
...
以下是&#x200B;**mailExplorer**&#x200B;節點的不同引數。 這是SMTP伺服器的設定。
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td> mxAddress<br /> </td> 
   <td> SMTP伺服器：用於傳輸電子郵件的SMTP伺服器IP位址。<br /> </td> 
   <td> 字串<br /> </td> 
   <td> <br /> </td> 
  </tr> 
  <tr> 
   <td> mxPort<br /> </td> 
   <td> 用於電子郵件傳輸之SMTP伺服器的TCP連線埠。<br /> </td> 
   <td> 字串<br /> </td> 
   <td> 25<br /> </td> 
  </tr> 
 </tbody> 
...
以下是&#x200B;**模組**&#x200B;節點的不同引數。 這是名稱空間限制模組xtk的設定。
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> 準備時間上限：傳遞動作不再準備的持續時間（以秒為單位）。<br /> </td> 
   <td> 長<br /> </td> 
   <td> 3600<br /> </td> 
  </tr> 
  <tr> 
...
以下是&#x200B;**ooconv**&#x200B;節點的不同引數。 這是檔案轉換伺服器的設定。
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> 允許OpenOffice伺服器執行的最大轉換次數。 超過此數目後，伺服器就會重新啟動。<br /> </td> 
   <td> 長<br /> </td> 
   <td> 1000<br /> </td> 
  </tr> 
  <tr> 
...
以下是&#x200B;**proxyConfig**&#x200B;節點的不同引數。 這是Proxy引數的設定。

如需其他資訊，請參閱[Proxy連線設定](file-res-management.md)。
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 唯一的Proxy伺服器：對所有型別的Proxy使用相同的組態。<br /> </td> 
   <td> 布林值<br /> </td> 
   <td> false<br /> </td> 
  </tr> 
 </tbody> 
...
在&#x200B;**proxyConfig > HTTP Proxy / Secure Proxy**&#x200B;節點中，設定下列引數。
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td> 位址<br /> </td> 
   <td> Proxy伺服器<br />的位址 </td> 
   <td> 字串<br /> </td> 
  </tr> 
  <tr> 
   <td> 登入<br /> </td> 
   <td> 用於連線至Proxy伺服器<br />的登入 </td> 
   <td> 字串<br /> </td> 
  </tr> 
  <tr> 
   <td> 密碼<br /> </td> 
   <td> 與Proxy伺服器<br />連線的密碼 </td> 
   <td> 字串<br /> </td> 
  </tr> 
  <tr> 
   <td> 連線埠<br /> </td> 
...
以下是&#x200B;**urlPermission**&#x200B;節點的不同引數。 這是Javascript程式碼可以存取的URL清單。

網域和規則運算式的清單，指定Adobe Campaign伺服器能否使用在Javascript程式碼中遇到的URL。

如果找不到URL，則會根據指定的預設模式執行預設動作。

如需其他資訊，請參閱[傳出連線保護](../../installation/using/configuring-campaign-server.md#url-permissions)。
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td> 動作<br /> </td> 
   <td> URL不在授權清單（分項清單）中的預設動作。 可能的值為「忽略」（在沒有警告訊息的情況下授權，這需要停用保護）、「警告」（授權並發出警告訊息）和「拒絕」（禁止存取URL）。<br /> </td> 
   <td> 字串<br /> </td> 
   <td> 拒絕<br /> </td> 
  </tr> 
  <tr> 
   <td> debugTrace<br /> </td> 
   <td> URL選擇機制的偵錯追蹤：在URL驗證程式期間發出其他訊息。<br /> </td> 
   <td> 布林值<br /> </td> 
   <td> false<br /> </td> 
  </tr> 
 </tbody> 
...
如果記錄符合&#x200B;**dnsSuffix**，但不符合&#x200B;**urlRegEx**，則會檢查下列記錄。
...
以下是&#x200B;**xtkJobs**&#x200B;節點的不同引數。 這是伺服器作業的設定。
...
以下是&#x200B;**封存**&#x200B;節點的不同引數。 這是在背景執行的封存作業的設定。
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 封存期間使用的壓縮格式（列舉）。 可能的值為'0' （無壓縮）和'1' （使用zip格式壓縮已傳送的訊息）。<br /> </td> 
   <td> 位元組<br /> </td> 
   <td> 1<br /> </td> 
  </tr> 
  <tr> 
   <td> expirationDelay<br /> </td> 
   <td> 自動封存未處理的電子郵件之前的延遲：封存未處理的電子郵件之前的天數。<br /> </td> 
   <td> 長<br /> </td> 
   <td> 2<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 處理序自動重新啟動的時間（一天中的時間）。 請參閱<a href="../../installation/using/configuring-campaign-server.md#automatic-process-restart" target="_blank">自動處理程式重新啟動</a>.<br /> </td> 
   <td> 字串<br /> </td> 
   <td> '06:00:00' <br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 啟用SMTPS支援：當遠端伺服器支援時，在安全模式(STARTTLS/SMTPS)中啟用電子郵件的傳遞。<br /> </td> 
   <td> 布林值<br /> </td> 
   <td> false<br /> </td> 
  </tr> 
  <tr> 
...
以下是&#x200B;**inMail**&#x200B;節點的不同引數。 這是傳入電子郵件管理模組的設定。
...
在&#x200B;**inMail > msgDump**&#x200B;節點中，設定下列引數。 這是已處理訊息傾印的設定。
...
以下是&#x200B;**interactiond**&#x200B;節點的不同引數。 這是輸入互動事件的寫入精靈設定。

如需其他資訊，請參閱[互動 — 資料緩衝區](../../installation/using/interaction-data-buffer.md)。
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> mta處理序可以使用的記憶體大小上限(MB)。 超過此限制後，處理程式會重新啟動，以便將其使用的記憶體釋放給系統。<br /> </td> 
   <td> 長<br /> </td> 
   <td> 1024<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 重試遺失的訊息：如果子處理序已終止，將會重試部分傳遞。<br /> </td> 
   <td> 布林值<br /> </td> 
   <td> true<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 啟用簽章機制。 這會改善電子郵件中追蹤連結的安全性。<br /> </td> 
   <td> 布林值<br /> </td> 
   <td> true<br /> </td> 
  </tr>
  <tr> 
  ...
  <tr> 
   <td> verifyMode<br /> </td> 
   <td> 驗證模式：啟用驗證模式（沒有實際的訊息傳輸；用於模擬和測試）。<br /> </td> 
   <td> 布林值<br /> </td> 
   <td> false<br /> </td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> 在以下時段後回收：時段（以秒為單位），過了這段時間後，將自動從快取中刪除檔案以回收儲存空間。<br /> </td> 
   <td> 長<br /> </td> 
   <td> 244800<br /> </td> 
  </tr> 
  <tr> 
...
在&#x200B;**mta >轉送**&#x200B;節點中，設定下列引數。 這是郵件傳遞的郵件伺服器設定。
...
在&#x200B;**mta > master**&#x200B;節點中，設定下列引數。 這是主要伺服器的設定。
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 子伺服器的最小數量。 MTA會嘗試至少將此數量的伺服器保持執行。 如果少於此值，它會每秒重新啟動新伺服器，直到達到此值。<br /> </td> 
   <td> 長<br /> </td> 
   <td> 0<br /> </td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 閒置子伺服器停止之前的逾時。 如果子伺服器的閒置時間大於此引數，它將自動終止以釋放主機資源。<br /> </td> 
   <td> 長<br /> </td> 
   <td> 60<br /> </td> 
  </tr> 
  <tr> 
   <td> maxAgeSec<br /> </td> 
   <td> 最長訊息保留時間。 如果準備好的訊息因節流而無法傳送或無法連線到目標MTA，則會捨棄該訊息，並於下次重試時進行處理。<br /> </td> 
   <td> 長<br /> </td> 
   <td> 600<br /> </td> 
  </tr> 
  <tr> 
   <td> maxGCMConnectPerChild<br /> </td> 
   <td> 每個子伺服器向FCM起始的最大平行HTTP要求數目。<br /> </td> 
   <td> 長<br /> </td> 
   <td> 8<br /> </td> 
  </tr> 
  <tr> 
...
在&#x200B;**mta >子項> smtp**&#x200B;節點中，設定下列引數。 這是SMTP工作階段的設定。
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td> enableTLS<br /> </td> 
   <td> 當遠端伺服器支援時，在安全模式(STARTTLS/SMTPS)中啟用電子郵件的傳遞。<br /> </td> 
   <td> 布林值<br /> </td> 
   <td> false<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 重試連線之前的初始延遲。 每次連線失敗時，這個延遲都會加倍。<br /> </td> 
   <td> 長<br /> </td> 
   <td> 4<br /> </td> 
  </tr> 
  <tr> 
...
在&#x200B;**mta >子項> smtp > IPAffinity**&#x200B;節點中，設定下列引數。 這是針對最佳化的傳出SMTP流量，設定與IP位址的相似性管理。
...
以下是&#x200B;**nmac**&#x200B;節點的不同引數。 這是用於推播通知傳送的設定。
...
以下是&#x200B;**nmac >轉送**&#x200B;節點的不同引數。 這會設定訊息傳送（ios http2聯結器）的轉送使用。
...
以下是&#x200B;**管線化**&#x200B;節點的不同引數。 這是管道服務的事件處理模組設定。
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 用來取得權杖的私密金鑰（使用XtkKey選項以AES加密）。<br /> </td> 
   <td> 字串<br /> </td> 
   <td> <br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 狀態伺服器連線埠：可讓您查詢處理序狀態的HTTP伺服器連線埠。 若為0.<br />，則不啟用 </td> 
   <td> 長<br /> </td> 
   <td> 7781<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 使用個人化JavaScript聯結器進行事件處理的執行緒數目。<br /> </td> 
   <td> 長<br /> </td> 
   <td> 4<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 在此時段後捨棄：如果在此時段後處理仍失敗，則捨棄該事件。<br /> </td> 
   <td> 長<br /> </td> 
   <td> 300<br /> </td> 
  </tr> 
  <tr> 
...
以下是&#x200B;**securityZone > subNetwork**&#x200B;節點的不同引數。
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> proxy<br /> </td> 
   <td> 此子網路用於存取執行個體的（反向） Proxy遮罩或位址。 在此情況下，將測試'X-Forwarded-For'標頭而非此Proxy。<br /> </td> 
   <td> 字串<br /> </td> 
   <td> 127.0.0.1 <br /> </td> 
  </tr> 
 </tbody> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 工作階段持續性框架的週期：最大值。 兩個框架之間的期間（以秒為單位），用於通知接收工作階段仍處於啟用狀態。<br /> </td> 
   <td> 長<br /> </td> 
   <td> 25<br /> </td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> 與Netsize建立連線時的逾時（以秒為單位）。<br /> </td> 
   <td> 長<br /> </td> 
   <td> 30<br /> </td> 
  </tr> 
 </tbody> 
...
以下是&#x200B;**syslogd**&#x200B;節點的不同引數。 這是記錄管理模組的設定。
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 刪除重複的開啟專案：移除重複的開啟追蹤記錄檔，以限制郵件閱讀程式（例如Outlook）中郵件預覽的影響。<br /> </td> 
   <td> 長<br /> </td> 
   <td> 1<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td> 指示器持續時間<br /> </td> 
   <td> 計算指標期間：傳遞有效日期之後的期間，過了這段期間後，將不再計算合併的指標。<br /> </td> 
   <td> 長<br /> </td> 
   <td> 2592000<br /> </td> 
  </tr> 
  <tr> 
   <td> initScript<br /> </td> 
   <td> 啟動處理序<br />時要執行的JavaScript識別碼 </td> 
   <td> 字串<br /> </td> 
   <td> <br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> Phishbowl服務端點整合的端點。 這樣可保護從舊組建產生的格式錯誤的URL重新導向。<br /> </td> 
   <td> 長<br /> </td> 
   <td> <br /> </td> 
  </tr> 
  <tr> 
...
以下是&#x200B;**trackinglogd**&#x200B;節點的不同引數。 這是追蹤記錄寫入精靈的設定。
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 最大寫入重試次數：在記錄檔寫入失敗時可建立的最大檔案數。<br /> </td> 
   <td> 長<br /> </td> 
   <td> 5<br /> </td> 
  </tr> 
  <tr> 
   <td> maxLogsSizeOnDiskMb<br /> </td> 
   <td> 最大記錄檔大小：記錄檔在磁碟上使用的最大空間(MB)。 不可少於100 MB。<br /> </td> 
   <td> 長<br /> </td> 
   <td> 500<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 最大記錄計數：共用記憶體中儲存的最大記錄數。 不能小於10000。<br /> </td> 
   <td> 長<br /> </td> 
   <td> 25000<br /> </td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> maxProcessMemoryWarningMb<br /> </td> 
   <td> 記憶體耗用警告：關於指定處理序<br />耗用的RAM數量(Mb)的警告 </td> 
   <td> 長<br /> </td> 
   <td> 1600<br /> </td> 
  </tr> 
  <tr> 
...
以下是&#x200B;**Web > jsp**&#x200B;節點的不同引數。 這是JSP使用的參陣列態。
...
**Web > jsp > classpath**&#x200B;節點包含啟動JVM時要使用的所有類別路徑清單。 以下是預設設定：
...
以下是&#x200B;**Web > jssp**&#x200B;節點的不同引數。 這是JSSP使用的引數設定。
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td> collectorsGarbageAfterRequest<br /> </td> 
...
**Web > jsp > classpath**&#x200B;節點包含啟動JVM時要使用的所有類別路徑清單。

### 轉送 {#relay-2}

以下是&#x200B;**網頁>轉送**&#x200B;節點的不同引數。 這是兩個區域之間HTTP要求的轉送設定。
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td> debugRelay<br /> </td> 
   <td> 以偵錯模式啟動Web伺服器中的HTTP轉送模組。<br /> </td> 
   <td> 布林值<br /> </td> 
   <td> false<br /> </td> 
  </tr> 
  <tr> 
...
為每個要轉送的URL新增&#x200B;**Web >轉送> url**&#x200B;節點（插入順序定義優先順序），引數如下。

如需詳細資訊，請參閱[動態頁面安全性與轉送](../../installation/using/configuring-campaign-server.md#dynamic-page-security-and-relays)與[區段](../../installation/using/deploying-an-instance.md#synchronizing-public-resources)。
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> 狀態<br /> </td> 
   <td> 公用資源的同步狀態（列舉）。 可能的值包括「正常」（正常執行）、「黑名單」（在錯誤404時新增至封鎖清單的URL）和「備用」（如果存在，檔案會上傳到備用伺服器）。<br /> </td> 
   <td> 字串<br /> </td> 
   <td> normal<br /> </td> 
  </tr> 
  <tr> 
...
為每個HTTP標頭新增&#x200B;**web > relay > responseHeader**&#x200B;節點，以新增至轉送至轉送的回覆。
...
以下是&#x200B;**Web >重新導向**&#x200B;節點的不同引數。 這是重新導向模組的設定。
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> databaseId<br /> </td> 
   <td> 與追蹤執行個體關聯的資料庫識別碼。<br /> </td> 
   <td> 字串<br /> </td> 
   <td> <br /> </td> 
  </tr> 
  <tr> 
   <td> defLogCount<br /> </td> 
   <td> 依據呼叫的記錄計數：在呼叫GetTrackingLogs方法時，預設傳回的記錄數。<br /> </td> 
   <td> 長<br /> </td> 
   <td> 30<br /> </td> 
  </tr> 
  <tr> 
   <td> expirationURL<br /> </td> 
   <td> 過期重新導向的頁面：當傳遞動作的重新導向過期時，重新導向伺服器預設會使用之網頁的URL。<br /> </td> 
   <td> 字串<br /> </td> 
   <td> <br /> </td> 
  </tr> 
  <tr> 
...
以下是&#x200B;**Web >重新導向> spareServer**&#x200B;節點的不同引數。

如需其他資訊，請參閱[備援追蹤](../../installation/using/configuring-campaign-server.md#redundant-tracking)。
...
以下是&#x200B;**網頁> spamCheck**&#x200B;節點的不同引數。 這是電子郵件反垃圾郵件評分評估引數的設定。
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td> 命令<br /> </td> 
   <td> 評估電子郵件的反垃圾郵件分數所要執行的命令（例如「perl spamcheck.pl」）。<br /> </td> 
   <td> 字串<br /> </td> 
  </tr> 
 </tbody> 
</table>
...
以下是&#x200B;**wfserver**&#x200B;節點的不同引數。 這是工作流程程式設定。
