...
* 步驟 **6**, **9** 和 **10** 沒必要。
* 步驟期間 **12** 和 **13**，您必須在連線URL中指定8080埠（因為主控台會直接與Tomcat通訊，而非透過Web伺服器）。 URL會變成 [http://console.campaign.net:8080](http://console.campaign.net). 步驟期間 **13**，請選取 **[!UICONTROL Issue towards Mid-sourcing]** 套件以及要安裝的套件。
