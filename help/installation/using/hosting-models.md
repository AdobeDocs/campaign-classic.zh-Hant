...
* 根據您的環境，閱讀Windows[的](../../installation/using/prerequisites-of-campaign-installation-in-windows.md)必要條件和Linux[的](../../installation/using/prerequisites-of-campaign-installation-in-linux.md)必要條件。
* 在本節[中瞭解與資料庫引擎](../../installation/using/database.md)相關的建議。
...
* 請參閱本文[中評估內部部署硬體需求](https://helpx.adobe.com/tw/campaign/kb/hardware-sizing-guide.html)的一般准則。
...
* 若要深入瞭解中間來源部署原則，請參閱本節[中的](../../installation/using/mid-sourcing-deployment.md)。
