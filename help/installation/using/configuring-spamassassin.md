...
1. 連線至 [軟體發佈入口網站](https://experience.adobe.com/#/downloads/content/software-distribution/en/campaign.html) 使用您的使用者認證。 進一步瞭解中的軟體發佈 [此頁面](https://experienceleague.adobe.com/docs/experience-cloud/software-distribution/home.html?lang=zh-Hant).
...
1. 前往您解壓縮檔案的檔案，然後按兩下 **run_me.bat** 檔案以啟動安裝指令碼。
...
1. 若要檢查SpamAssassin安裝是否成功，請使用以下程式使用GTUBE測試（針對未經請求的大量電子郵件的通用測試）：
   ...
   1. 按兩下 **portableShell.bat** 檔案以顯示Windows Shell，然後啟動以下命令(或&quot;`<root>`&quot;會在解壓縮時指定建立的資料夾  **spamassassin.zip** 檔案)：
...
篩選器規則可使用以下自動更新： **sa-update** 工具。 請參閱官方SpamAssassin網站 [https://spamassassin.apache.org/](https://spamassassin.apache.org/) 以取得詳細資訊。
