...
>[!NOTE]
>
>在FDA中連線至Teradata外部資料庫需要Adobe Campaign伺服器上的其他設定步驟。 [了解更多資訊](#teradata-additional-configurations)。
>
...
錯誤&#x200B;**ODB-240000 ODBC錯誤： \[Microsoft\]\[ODBC驅動程式管理員\]找不到資料來源名稱，且未指定預設驅動程式。** 若使用16.X驅動程式，就會在Windows上發生。 Adobe Campaign預期teradata在odbcinst.ini中命名為&#39;{teradata}&#39;。
