...
| Option | 說明 |
|---|---|
| TD_MAX_SESSIONS | 指定Teradata並行傳送程式可為操作員作業獲取的最大登錄會話數。 <br>[如需關於此項目的詳細資訊，請參閱此頁面](https://documentation.sas.com/doc/en/pgmsascdc/9.4_3.5/ds2ref/p1naft0um1kn3vn1ubgkrjdf7c3a.html). |
| 時區名稱 | 伺服器時區的名稱。 |
...
| IANAAppCodePage | 「ODBC應用程式代碼」頁。 <br>[如需關於此項目的詳細資訊，請參閱此頁面](https://docs.teradata.com/r/ODBC-Driver-for-Teradata-User-Guide/May-2017/ODBC-Driver-for-Teradata-Application-Development/International-Character-Set-Support/Application-Code-Page) |
