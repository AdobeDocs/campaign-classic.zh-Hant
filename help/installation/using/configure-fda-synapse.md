...
| Option | 說明 |
|---|---|
| 驗證 | 連接器支援的驗證類型。 目前支援的值：ActiveDirectoryMSI。 </br>如需詳細資訊，請參閱 [SQL文檔](https://docs.microsoft.com/en-us/sql/connect/odbc/using-azure-active-directory?view=sql-server-ver15#example-connection-strings) (連線字串範例n°8)。 |
