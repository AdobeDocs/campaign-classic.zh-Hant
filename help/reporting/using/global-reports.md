...
>[!NOTE]
>
>此報告中顯示的域名在多維資料集級別定義。 若要變更這些值，請編輯 **[!UICONTROL Delivery logs (broadlogrcp)]** 立方體。 如需詳細資訊，請參閱[本章節](../../reporting/using/about-cubes.md)。此 **[!UICONTROL Others]** 類別包含不屬於特定類的域名。
