...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> 共用<br /> </td> 
   <td> @shared<br /> </td> 
   <td> 包含在「電子郵件」、「facebook」、「twitter」、「delicious」、「digg」、「google」、「linkedin」中的URL類別<br /> URL類別等於「email」、「facebook」、「twitter」、「delicious」、「digg」、「google」或「linkedin」的所有@totalClicks戶計數。<br /> </td> 
