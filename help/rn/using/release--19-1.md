...
![](assets/green_2.png) 2020 **年4月3日**:新建版本(9032-...e8b36257e)，其中包含下列修正：

* 我們將引進簽名機制來追蹤電子郵件中的連結，以防止潛在的惡意使用（網路釣魚）。 這可防止追蹤參數的重寫，這些參數可能包含用於重新導向使用者的URL。 此機制目前預設為停用。 如果您需要啟用，請聯絡客戶服務。

* 已新增互補的安全性保護，以防止重新導向從先前建置或關閉簽名機制時產生的格式錯誤URL。 如果您需要使用，請聯絡客戶服務。

![](assets/orange_2.png) 2020 **年3月5日**:新建版本(9032-...205c981c3)，包含下列修正：
