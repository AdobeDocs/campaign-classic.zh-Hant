...
啟動Campaign Classic 19.2時，狀態會關聯至每個建置。 您會在狀態清單下方找到狀態、狀態的含義和相關影像：

![](assets/green2.png)**一**&#x200B;般可用性：最新穩定版本。

![](assets/blue2.png)**發**&#x200B;行候選人：經過Adobe驗證，等待生產校樣。

![](assets/orange2.png)**不**&#x200B;再提供：更新版本可用，需要更新。

![](assets/green3.png)**一**&#x200B;般可用性：最新穩定版本。

![](assets/blue3.png)**發**&#x200B;行候選人：經過Adobe驗證，等待生產校樣。

![](assets/orange3.png)**不**&#x200B;再提供：更新版本可用，需要更新。
...
<table> 
 <tbody> 
  <tr> 
   ...
   <td>發行候選人</td>
   <td>此建置版本已由Adobe驗證。  等待生產校對。</td>
  </tr> 
  <tr> 
   <td><img src="assets/orange.png"/></td> 
   <td>不再提供</td>
   <td>此建置版本不會有重大問題，但有較新的建置版本可提供額外的錯誤修正。 需要更新。</td>
  </tr> 
 </tbody> 
</table>
...
<tr>
  ...
  <td>
    ...
    <div>
    <img src="assets/blue3.png"/><strong>發行候選人</strong>
    </div>
    <p>
    <em>此建置版本已由Adobe驗證。 等待生產校對。</em>
    <p>
  </td>
   <td>
    <img src="assets/update.png" />
    <div>
    <img src="assets/orange3.png"/><strong>不再提供</strong>
    </div>
    <p>
    <em>此建置版本不會有重大問題，但有較新的建置版本可提供額外的錯誤修正。 需要更新。</em>
    <p>
  </td>
</tr>
</table>
...
| 其他資源： |  |
|--- |--- |
| [升級至最新版本](https://helpx.adobe.com/campaign/kb/acc-build-upgrade.html) | [控制面板版本注意事項](https://docs.adobe.com/content/help/en/control-panel/using/release-notes.html) |
| [最新檔案更新](../../rn/using/documentation-updates.md) | [舊版注意事項](../../rn/using/release--19-1.md) |
| [被取代和已移除的功能](https://helpx.adobe.com/campaign/kb/deprecated-and-removed-features.html) |  |

## ![](assets/blue2.png) 版本19.2 - Build 9080 {#release-19-2-build-9080}
