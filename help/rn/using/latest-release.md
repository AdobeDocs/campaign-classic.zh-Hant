...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <p>巴西的 Lei Geral de Proteção de Dados (LGPD) 將於 8 月 16 日生效，所有於巴西收集或處理個人資料的公司皆適用。</p>
...
* 修正了從追蹤 URL 重新導向時，刪除編碼參數值的問題。(NEO-25637)
...
* 修正了測試 acsDefaultAccount 外部帳戶的連線時出現的問題。(NEO-23433)
...
* 修正了 Microsoft Dynamics CRM 無法擷取所有實體的問題。(NEO-24528)
