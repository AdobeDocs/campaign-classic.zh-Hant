...
<table> 
 <tbody> 
  ...
  <tr>
 <td>Netsize SMPP 連接器</td>
 <td><p>Netsize SMPP 連接器現已棄用。建議移轉至 <strong>Extended generic SMPP</strong> 連接器。如需詳細資訊，請參閱<a href="../../delivery/using/unsupported-connector-migration.md">本頁面</a>。</p>
<p>目標移除日期：2027 年 1 月</p>
</td>
</tr>
<tr>
...
<table> 
 <tbody>
  ...
  <td><p> 自 Campaign 第 21.1.3 發行版本開始，已棄用使用於匯入和匯出客群至 Adobe Experience Cloud 的 Demdex 網域。 <a href="../../integrations/using/configuring-shared-audiences-integration-in-adobe-campaign.md">瞭解更多</a></p> 
   ...
   <td><p>自 Campaign 第 20.3 發行版本開始，在使用 Microsoft SQL Server 設定新的資料庫時，已將 Windows NT 驗證從可用的驗證方法中移除。<a href="../../installation/using/creating-and-configuring-the-database.md#step-1---selecting-the-database-engine">瞭解更多</a></p></td>
  </tr>
   <tr> 
   <td>檔案式電子郵件封存<br></td>
...
* 從 7.3.4 版本開始，Adobe Campaign 不再與 Red Hat Enterprise Linux (RHEL) 7 相容。
