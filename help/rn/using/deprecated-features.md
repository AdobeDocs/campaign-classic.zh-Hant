...
<table> 
 <tbody>
  ...
  <tr>  
   <td>傳真頻道<br></td>
   <td><p>自 Campaign 21.1.3 版開始，不再提供傳真頻道。 <a href="https://experienceleague.adobe.com/docs/campaign/campaign-v8/send/create-message.html" target="_blank">在Campaign v8檔案中進一步瞭解</a></p>
  </tr>
  <tr>
  <td>Demdex 網域<br></td>
