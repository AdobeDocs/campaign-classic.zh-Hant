...
* Web伺服器：Apache 2.2.更 [多資訊](https://wiki.centos.org/About/Product)
...
* RHEL 6.x.了 [解詳細內容](https://access.redhat.com/support/policy/updates/errata)。
...
* PostgreSQL 9.3.了 [解詳細內容](https://www.postgresql.org/support/versioning)。
* MySQL 5.5. &lt;了[解詳細內容](http://www.fromdual.com/support-for-mysql-from-oracle)。
* DB2 9.5.了 [解詳細內容](http://www-01.ibm.com/support/docview.wss?uid=swg21168270)。
* Teradata 14 - 14.1.了 [解詳細內容](https://community.teradata.com/t5/Database/Teradata-Database-Product-Life-Cycle/td-p/35068)。
