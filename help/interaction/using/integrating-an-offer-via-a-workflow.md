...
>[!NOTE]
>
>如需擴充活動的詳細資訊，請參閱 [工作流程手冊](../../workflow/using/enrichment.md).
...
1. 然後設定與您選擇的通道相對應的傳送活動。 有關詳細資訊，請參閱 [在傳送中插入優惠方案主張](../../interaction/using/integrating-an-offer-via-the-wizard.md#inserting-an-offer-proposition-into-a-delivery) 區段。
...
>[!NOTE]
>
>記住：此 **[!UICONTROL Offer engine]** 活動預設會儲存此資訊。

不過，您可以依下列方式儲存此資訊：

1. 在查詢後和傳送活動前放置的擴充活動中，建立對選件引擎的呼叫。 請參閱 [指定優惠方案或對優惠方案引擎的呼叫](../../interaction/using/integrating-an-offer-via-a-workflow.md#specifying-an-offer-or-a-call-to-the-offer-engine) 區段。
