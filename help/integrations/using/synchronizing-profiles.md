...
如需有關Campaign Standard工作流程的詳細資訊和完整指示，請參閱工 [作流程](../../workflow/using/about-workflows.md)。
...
請依照下列步驟，將電子郵件傳送新增至現有的工作流程，並使用在Campaign v7中建立的取消訂閱服務。 如需有關Campaign Standard工作流程的詳細資訊和完整指示，請參閱本 [檔案](../../workflow/using/about-workflows.md)。
