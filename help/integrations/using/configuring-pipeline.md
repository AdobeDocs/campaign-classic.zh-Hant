...
* Adobe I/O專案驗證
* 有效的組織ID — 若要尋找組織ID，請參閱 [本頁](https://experienceleague.adobe.com/docs/core-services/interface/administration/organizations.html?lang=zh-Hant){_blank}
* 對貴組織的開發人員存取
...
| discoverPipelineEndpoint | 尋找要用於此租用戶的Pipeline Services端點的URL。 預設: ```https://producer-pipeline-pnw.adobe.net``` |
