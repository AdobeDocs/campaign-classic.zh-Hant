...
>
>* 請注意，您的執行個體必須升級為[最新GA組建](../../rn/using/rn-overview.md)。 在[本章節](../../platform/using/launching-adobe-campaign.md#getting-your-campaign-version){target="_blank"}中瞭解如何確認您的版本。
...
1. 疑難排解&#x200B;**工作階段記錄**：
   ...
   1. 在工作流程中，連按兩下[檔案傳輸](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/event-activities/file-transfer.html?lang=zh-Hant){target="_blank"}活動。
