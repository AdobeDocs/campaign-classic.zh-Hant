...
深入了解 [預先定義的篩選](../../platforrm/using/creating-filters.md).
+++
...
深入了解 [主鍵](../../configuration/using/key.md).
+++
...
深入了解 [目標資料](../../workflow/using/define-the-right-audience.md#target-mappings).
+++
...
深入了解 [類型](../../campaign/using/about-campaign-typologies.md#typology-rules).
+++
...
深入了解 [類型](../../campaign/using/about-campaign-typologies.md#typologies).
+++
