...
Adobe Campaign查詢工具可讓您使用專用的精靈來查詢資料庫：一般查詢編輯器。 可透過&#x200B;**[!UICONTROL Tools > Generic query editor...]**&#x200B;功能表存取它。 透過它，您可擷取儲存在資料庫中的資訊，將其整理、分組、排序等操作。例如，使用者可以在新聞稿的連結上，還原在給定時間內按一下連結超過 [n] 次以上的收件者。透過這個工具，您可根據您的需求收集、排序和顯示結果。
