...
https://experienceleague.adobe.com/docs/campaign-standard-learn/tutorials/privacy/privacy-overview.html?lang=zh-Hant
-->
...
有關「存取權管理」的詳細資訊，請參閱[詳細文件](../../platform/using/access-management.md)。
