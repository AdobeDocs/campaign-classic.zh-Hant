...
Access **和** Delete **requests are presended in** this section [](../../platform/using/privacy-management.md#right-access-forgotten).

建立這些請求的實作步驟在本節中 [詳述](../../platform/using/privacy-requests.md)。
