...
>* 若要進一步瞭解CRM聯結器，以及如何連線至Microsoft Dynamics和Salesforce，請參閱[Campaign v8檔案](https://experienceleague.adobe.com/zh-hant/docs/campaign/campaign-v8/connect/ac-crm/crm){target=_blank}。
