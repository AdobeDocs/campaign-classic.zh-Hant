...
您可以將檔案和行銷資源新增至任務（如需詳細資訊，請參閱[管理行銷資源](../../campaign/using/managing-marketing-resources.md)）。 要執行此操作，請開啟任務，然後按一下任務工具欄中的&#x200B;**[!UICONTROL Documents]**&#x200B;表徵圖。
...
>[!NOTE]
>
>管理預算和成本的方法在[控製成本](../../campaign/using/controlling-costs.md)中列出。
...
在任務控制面板中，操作員名稱旁的表徵圖表示他們已在任務涵蓋的期間內處理另一個任務或事件。 (操作員負責或涉及的任務：它顯示在&#x200B;**[!UICONTROL Assigned to]**&#x200B;欄位或任務&#x200B;**[!UICONTROL Resources]**&#x200B;框中。
