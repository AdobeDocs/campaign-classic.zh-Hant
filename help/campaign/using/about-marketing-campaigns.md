...
* [行銷資源管理](https://experienceleague.adobe.com/docs/campaign/automation/mrm/about-marketing-resource-management.html?lang=zh-Hant){target=_blank}：此模組可讓您在合作模式中控制行銷動作，方法是提供相關工作、預算和行銷資源的完整管理和即時追蹤。

* [分散式行銷](https://experienceleague.adobe.com/docs/campaign/automation/distributed-marketing/about-distributed-marketing.html?lang=zh-Hant){target=_blank}：此模組可讓您藉由提供相關工作、預算與行銷資源的完整管理與即時追蹤，以合作模式控制行銷動作。
