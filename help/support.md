...
<table>
   ...
   <td valign="top">
        ...
        <li><a href="https://experienceleague.adobe.com/en/docs/campaign/campaign-v8/analytics/tracking/tracking" target="_blank">認識追蹤管理</a></li>
    ...
    <td valign="top">
        ...
        <li><a href="delivery/using/delivery-failures-quarantine.md">認識隔離管理</a></li>
        ...
        <li><a href="platform/using/adobe-campaign-workspace.md#about-queries-in-campaign">設計查詢</a></li>
