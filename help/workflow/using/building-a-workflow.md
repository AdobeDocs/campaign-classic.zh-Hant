...
## 新增及連結活動 {#adding-and-linking-activities}
...
* **影像管理**
   ...
   您可以自訂圖表的背景影像，以及與各種活動相關的背景影像。 請參閱 [變更活動影像](managing-activity-images.md).
...
1. **準備** 滿足傳遞需求的資料 — 請參閱 [豐富和修改資料](targeting-data.md#enriching-and-modifying-data)
