...
1. **正在接收檔案**
   ...
   若要接收儲存在遠端伺服器上的檔案，請在&#x200B;**[!UICONTROL File download]**&#x200B;欄位中選取&#x200B;**[!UICONTROL Action]**。 您必須在相關欄位中指定其URL。
...
1. **檔案傳輸**
   ...
   若要將檔案傳送至伺服器，請在&#x200B;**[!UICONTROL File upload]**&#x200B;欄位中選取&#x200B;**[!UICONTROL Action]**。 您必須在編輯器的&#x200B;**[!UICONTROL Remote server]**&#x200B;區段中指定目標伺服器。 這些引數與傳入檔案的相同。 請參閱上文。
...
1. **測試以檢視檔案是否存在**
   ...
   若要測試檔案是否存在，請在&#x200B;**[!UICONTROL Test to see if file exists]**&#x200B;欄位中選取&#x200B;**[!UICONTROL Action]**&#x200B;選項。 遠端伺服器的設定與檔案下載的設定相同。 如需詳細資訊，請參閱此[區段](#properties)。

   ![](assets/file_transfert_edit_test.png)

1. **檔案清單**

   若要列出檔案，請從&#x200B;**[!UICONTROL File listing]**&#x200B;欄位中選取&#x200B;**[!UICONTROL Action]**&#x200B;選項。 遠端伺服器的設定與接收檔案的設定相同。 如需詳細資訊，請參閱此[區段](#properties)。

   選取&#x200B;**[!UICONTROL List all files]**&#x200B;動作時可用的&#x200B;**[!UICONTROL File listing]**&#x200B;選項可讓您儲存所有存在於伺服器上事件變數&#x200B;**vars.filenames**&#x200B;中的檔案，其中檔案名稱以`\n`個字元分隔。
