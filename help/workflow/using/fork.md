...
在收件者生日當天會傳送循環電子郵件給收件者清單。 A **[!UICONTROL Fork]** 活動用於包含閏年2月29日出生的收件者。 [瞭解更多](sending-a-birthday-email.md) 關於此使用案例。
...
![分支活動會依循傳遞活動，並在查詢活動和內容管理活動之前進行，兩者都是透過AND聯結活動聯結。](../../delivery/using/assets/d_ncs_content_workflow10.png)
