...
* 身為混合型客戶，Adobe會通知您中間來源執行個體的排程升級日期。 Adobe強烈建議您也升級行銷執行個體。

  新組建版本可回溯相容於Campaign Classic 17.9版本，但Adobe強烈建議升級所有執行個體，以解決安全性弱點
...
如果您的執行個體是在比Campaign 19.1.8、20.2.4、Gold Standard 11 **舊的**&#x200B;版本上執行，那麼您是透過oAuth驗證使用舊版的Triggers整合： **您必須升級至較新版本，並移至Adobe I/O**。
...
此外，對於混合環境，客戶需要確保在中間來源執行個體上設定管道。 [了解更多資訊](../../integrations/using/configuring-pipeline.md)。
...
自2021年3月31日&#x200B;**起**，Apple推播通知服務(APN)不再支援舊版二進位通訊協定。 [閱讀更多](https://developer.apple.com/news/?id=c88acm2b)。
