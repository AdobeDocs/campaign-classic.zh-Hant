...
+ 建立及傳送訊息 {#sending-messages}
   ...
   + 快速入門 {#key-steps-when-creating-a-delivery}
      ...
      + [建立和識別傳遞 — 隱藏](delivery/using/steps-create-and-identify-the-delivery.md)
      + [定義對象 — 隱藏](delivery/using/steps-defining-the-target-population.md)
   ...
   + 關於傳遞的最佳實務 {#delivery-bestpractices}
      ...
      + [定義正確的對象 — 隱藏](delivery/using/define-the-right-audience.md)
      + [傳送前檢查 — 隱藏](delivery/using/check-before-sending.md)
   ...
   + 傳送電子郵件 {#sending-emails}
      ...
      + 傳送電子郵件傳遞 {#sending-an-email}
         ...
         + [電子郵件引數 — 隱藏](delivery/using/email-parameters.md)
   ...
   + 傳送推播通知 {#sending-push-notifications}
      ...
      + 設定行動應用程式{#configure-the-mobile-app}
         ...
         + [iOS的設定步驟 — 隱藏](delivery/using/configuring-the-mobile-application.md)
         + [Android的設定步驟 — 隱藏](delivery/using/configuring-the-mobile-application-android.md)
      + 建立推播通知{#create-a-push-msg}
         + [為iOS建立推送訊息 — 隱藏](delivery/using/create-notifications-ios.md)
         + [為Android建立推送訊息 — 隱藏](delivery/using/create-notifications-android.md)
      + [疑難排解 — 隱藏](delivery/using/troubleshooting.md)
   + [傳送直接郵件](delivery/using/about-direct-mail-channel.md)
   + 傳送直接郵件 {#sending-direct-mail}
      + [建立直接郵件傳送 — 隱藏](delivery/using/creating-a-direct-mail-delivery.md)
   ...
   + 使用傳遞範本 {#using-delivery-templates}
      ...
      + [選取目標對應 — 隱藏](delivery/using/selecting-a-target-mapping.md)
...
+ 協調行銷活動 {#orchestrating-campaigns}
   + [關於Campaign最佳化 — 隱藏](campaign-opt/using/about-campaign-optimization.md)
   ...
   + 協調行銷活動 {#orchestrate-campaigns}
      ...
      + [選取對象 — 隱藏](campaign/using/marketing-campaign-target.md)
      + [管理檔案和資產 — 隱藏](campaign/using/marketing-campaign-assets.md)
   ...
   + 行銷活動最佳化 {#campaign-optimization}
      + [關於行銷活動態樣 — 隱藏](campaign-opt/using/about-campaign-typologies.md)
...
+ 行銷資源管理 {#mrm}
   ...
   + [建立和管理任務 — 隱藏](mrm/using/creating-and-managing-tasks.md)
   + [控制成本 — 隱藏](mrm/using/controlling-costs.md)
   + [管理行銷資源 — 隱藏](mrm/using/managing-marketing-resources.md)
   + [論壇 — 隱藏](mrm/using/discussion-forums.md)
+ 分散式行銷 {#distributed-marketing}
   + [關於分散式行銷 — 隱藏](distributed/using/about-distributed-marketing.md)
   + [建立本機行銷活動 — 隱藏](distributed/using/creating-a-local-campaign.md)
   + [建立合作行銷活動 — 隱藏](distributed/using/creating-a-collaborative-campaign.md)
...
+ 使用工作流程自動化 {#automating-with-workflows}
   + 開始使用工作流程 {#introduction}
      ...
      + [建立工作流程 — 隱藏](workflow/using/building-a-workflow.md)
   ...
   + 目標定位活動 {#targeting-activities}
      ...
      + [依儲存格列出的優惠方案 — 隱藏](workflow/using/offers-by-cell.md)
      + [傳遞大網 — 隱藏](workflow/using/delivery-outline.md)
      + [擴充 — 隱藏](workflow/using/enrichment.md)
      + [編輯結構 — 隱藏](workflow/using/edit-schema.md)
   ...
   + 流程控制活動 {#flow-control-activities}
      ...
      + [跳到（起點和終點 — 隱藏）](workflow/using/jump-start-point-and-end-point.md)
   ...
   + 動作活動 {#action-activities}
      ...
      + [循環傳遞 — 隱藏](workflow/using/recurring-delivery.md)
      + [跨頻道傳遞 — 隱藏](workflow/using/cross-channel-deliveries.md)
      + [本地核准 — 隱藏](workflow/using/local-approval.md)
      + [資料載入(RDBMS) — 隱藏](workflow/using/data-loading-rdbms.md)
      + [載入中(SOAP) — 隱藏](workflow/using/loading-soap.md)
      + [資料載入（檔案） — 隱藏](workflow/using/data-loading-file.md)
      + [內容管理 — 隱藏](workflow/using/content-management.md)
      + [資料擷取（檔案） — 隱藏](workflow/using/extraction-file.md)
      + [SQL程式碼和JavaScript程式碼 — 隱藏](workflow/using/sql-code-and-javascript-code.md)
      + [SQL資料管理 — 隱藏](workflow/using/sql-data-management.md)
      + [Nlserver模組 — 隱藏](workflow/using/nlserver-module.md)
   ...
   + 資料管理 {#data-management}
      ...
      + [擴充資料 — 隱藏](workflow/using/enriching-data.md)
   ...
   + 查詢和篩選 {#designing-queries}
      ...
      + [新增分項清單型別計算欄位 — 隱藏](workflow/using/adding-enumeration-type-calculated-field.md)
   ...
   + 進階管理 {#advanced-management}
      ...
      + [進階引數 — 隱藏](workflow/using/advanced-parameters.md)
      + [JavaScript指令碼和範本 — 隱藏](workflow/using/javascript-scripts-and-templates.md)
      + [工作流程中的JavaScript程式碼範例 — 隱藏](workflow/using/javascript-in-workflows.md)
      + [存取外部資料庫 — 隱藏](workflow/using/accessing-an-external-database-fda.md)
      + [管理許可權 — 隱藏](workflow/using/managing-rights.md)
