...
+ 開始使用 {#getting-started}
   ...
   + [詞彙表 - 隱藏](platform/using/ac-glossary.md)
   + 隱私權 {#privacy}
...
+ 建立及傳送訊息 {#sending-messages}
   ...
   + [傳遞設定 - 隱藏](delivery/using/delivery-settings.md)
   + 快速入門 {#key-steps-when-creating-a-delivery}
      + [開始傳遞 - 隱藏](delivery/using/steps-about-delivery-creation-steps.md)
      + [建立並識別傳遞內容 - 隱藏](delivery/using/steps-create-and-identify-the-delivery.md)
      + [定義客群 - 隱藏](delivery/using/steps-defining-the-target-population.md)
      + [驗證傳遞 - 隱藏](delivery/using/steps-validating-the-delivery.md)
      + [傳送傳遞 - 隱藏](delivery/using/steps-sending-the-delivery.md)
      + [傳遞最佳實務 - 隱藏](delivery/using/delivery-best-practices.md)
   + 關於傳遞的最佳實務 {#delivery-bestpractices}
      + [最佳化傳遞 - 隱藏](delivery/using/optimize-delivery.md)
      + [使用範本 - 隱藏](delivery/using/use-templates.md)
   ...
   + 傳送電子郵件 {#sending-emails}
      ...
      + [定義電子郵件內容 - 隱藏](delivery/using/defining-the-email-content.md)
      + [定義互動式內容 - 隱藏](delivery/using/defining-interactive-content.md)
      + 傳送電子郵件傳遞 {#sending-an-email}
         + [傳送電子郵件的主要步驟 - 隱藏](delivery/using/sending-messages.md)
         + [電子郵件參數 - 隱藏](delivery/using/email-parameters.md)
         + [在日文的行動裝置上傳送 - 隱藏](delivery/using/sending-emails-on-japanese-mobiles.md)
      + [附加檔案 - 隱藏](delivery/using/attaching-files.md)
   + 傳送簡訊 {#sending-messages-on-mobiles}
      ...
      + [建立簡訊 - 隱藏](delivery/using/sms-create.md)
   ...
   + 傳送推播通知 {#sending-push-notifications}
      ...
      + 設定行動應用程式{#configure-the-mobile-app}
         + [開始使用應用程式設定 - 隱藏](delivery/using/get-started-app-config.md)
         + [針對 iOS 的設定步驟 - 隱藏](delivery/using/configuring-the-mobile-application.md)
         + [針對 Android 的設定步驟 - 隱藏](delivery/using/configuring-the-mobile-application-android.md)
      + 建立推播通知{#create-a-push-msg}
         + [為 iOS 建立推播訊息 - 隱藏](delivery/using/create-notifications-ios.md)
         + [為 Android 建立推播訊息 - 隱藏](delivery/using/create-notifications-android.md)
      + [疑難排解 - 隱藏](delivery/using/troubleshooting.md)
   + [傳送直接郵件](delivery/using/about-direct-mail-channel.md)
   + 傳送直接郵件 {#sending-direct-mail}
      + [建立直接郵件傳遞 - 隱藏](delivery/using/creating-a-direct-mail-delivery.md)
      + [定義直接郵件內容 - 隱藏](delivery/using/defining-the-direct-mail-content.md)
      + [驗證 - 隱藏](delivery/using/validating.md)
   + 使用傳遞範本 {#using-delivery-templates}
      + [使用傳遞範本 - 隱藏](delivery/using/about-templates.md)
      + [建立傳遞範本 - 隱藏](delivery/using/creating-a-delivery-template.md)
      + [選擇目標對應 - 隱藏](delivery/using/selecting-a-target-mapping.md)
      + [使用範本建立傳遞 - 隱藏](delivery/using/creating-a-delivery-from-a-template.md)
   + 個人化傳遞 {#personalizing-deliveries}
      ...
      + [個人化抵用券 - 隱藏](delivery/using/personalized-coupons.md)
      + [產生個人化 PDF 文件 - 隱藏](delivery/using/generating-personalized-pdf-documents.md)
...
+ 協調行銷活動 {#orchestrating-campaigns}
   + [關於行銷活動最佳化 - 隱藏](campaign-opt/using/about-campaign-optimization.md)
   + 關於行銷活動 {#about-marketing-campaigns}
      + [設計行銷活動 - 隱藏](campaign/using/designing-marketing-campaigns.md)
      + [存取行銷活動 - 隱藏](campaign/using/accessing-marketing-campaigns.md)
   + 協調行銷活動 {#orchestrate-campaigns}
      + [開始使用行銷活動 - 隱藏](campaign/using/setting-up-marketing-campaigns.md)
      + [建立及設定範本 - 隱藏](campaign/using/marketing-campaign-templates.md)
      + [新增傳遞 - 隱藏](campaign/using/marketing-campaign-deliveries.md)
      + [選取客群 - 隱藏](campaign/using/marketing-campaign-target.md)
      + [管理文件和資產 - 隱藏](campaign/using/marketing-campaign-assets.md)
      + [設定及管理核准 - 隱藏](campaign/using/marketing-campaign-approval.md)
      + [監視您的行銷活動 - 隱藏](campaign/using/marketing-campaign-monitoring.md)
      + [供應商、庫存和預算 - 隱藏](campaign/using/providers-stocks-and-budgets.md)
   + 行銷活動最佳化 {#campaign-optimization}
      + [關於行銷活動類型 - 隱藏](campaign-opt/using/about-campaign-typologies.md)
      + [壓力規則 - 隱藏](campaign-opt/using/pressure-rules.md)
      + [一致性規則 - 隱藏](campaign-opt/using/consistency-rules.md)
      + [控制規則 - 隱藏](campaign-opt/using/control-rules.md)
      + [篩選規則 - 隱藏](campaign-opt/using/filtering-rules.md)
      + [套用規則 - 隱藏](campaign-opt/using/applying-rules.md)
      + [行銷活動模擬 - 隱藏](campaign-opt/using/campaign-simulations.md)
+ 行銷資源管理 {#mrm}
   + [關於行銷資源管理 - 隱藏](mrm/using/about-marketing-resource-management.md)
   + [建立及管理設定檔 - 隱藏](mrm/using/creating-and-managing-tasks.md)
   + [控制成本 - 隱藏](mrm/using/controlling-costs.md)
   + [管理行銷資源 - 隱藏](mrm/using/managing-marketing-resources.md)
   + [討論論壇 - 隱藏](mrm/using/discussion-forums.md)
+ 分散式行銷 {#distributed-marketing}
   + [關於分散式行銷 - 隱藏](distributed/using/about-distributed-marketing.md)
   + [建立當地行銷活動 - 隱藏](distributed/using/creating-a-local-campaign.md)
   + [建立協作行銷活動 - 隱藏](distributed/using/creating-a-collaborative-campaign.md)
   + [發佈行銷活動套件 - 隱藏](distributed/using/publishing-the-campaign-package.md)
   + [存取行銷活動 - 隱藏](distributed/using/accessing-campaigns.md)
   + [追蹤行銷活動 - 隱藏](distributed/using/tracking-a-campaign.md)
   + [使用案例 - 隱藏](distributed/using/examples.md)
...
+ 使用工作流程自動化 {#automating-with-workflows}
   + 開始使用工作流程 {#introduction}
      + [關於活動 - 隱藏](workflow/using/about-activities.md)
      + [建置工作流程 - 隱藏](workflow/using/building-a-workflow.md)
      + [目標資料 - 隱藏](workflow/using/targeting-data.md)
      + [使用工作流程資料 - 隱藏](workflow/using/how-to-use-workflow-data.md)
      + [工作流程最佳實務 - 隱藏](workflow/using/workflow-best-practices.md)
   + 執行工作流程 {#executing-a-workflow}
      + [開始工作流程 - 隱藏](workflow/using/starting-a-workflow.md)
      + [工作流程生命週期 - 隱藏](workflow/using/workflow-life-cycle.md)
      + [資料生命週期 - 隱藏](workflow/using/data-life-cycle.md)
      + [定義核准 - 隱藏](workflow/using/defining-approvals.md)
      + [架構 - 隱藏](workflow/using/architecture.md)
   + 目標定位活動 {#targeting-activities}
      + [關於目標定位活動 - 隱藏](workflow/using/about-targeting-activities.md)
      + [查詢 - 隱藏](workflow/using/query.md)
      + [增量查詢 - 隱藏](workflow/using/incremental-query.md)
      + [讀取清單 - 隱藏](workflow/using/read-list.md)
      + [聯合 - 隱藏](workflow/using/union.md)
      + [交集 - 隱藏](workflow/using/intersection.md)
      + [排除 - 隱藏](workflow/using/exclusion.md)
      + [分割 - 隱藏](workflow/using/split.md)
      + [儲存格 - 隱藏](workflow/using/cells.md)
      + [依儲存格列出的產品建議 - 隱藏](workflow/using/offers-by-cell.md)
      + [傳遞大網 - 隱藏](workflow/using/delivery-outline.md)
      + [擴充 - 隱藏](workflow/using/enrichment.md)
      + [編輯結構描述 - 隱藏](workflow/using/edit-schema.md)
      + [優惠方案引擎 - 隱藏](workflow/using/offer-engine.md)
      + [重複資料刪除 - 隱藏](workflow/using/deduplication.md)
      + [變更維度 - 隱藏](workflow/using/change-dimension.md)
      + [清單更新 - 隱藏](workflow/using/list-update.md)
      + [訂閱服務 - 隱藏](workflow/using/subscription-services.md)
      + [更新資料 - 隱藏](workflow/using/update-data.md)
      + [CRM 連接器 - 隱藏](workflow/using/crm-connector.md)
      + [變更資料來源 - 隱藏](workflow/using/change-data-source.md)
   + 流程控制活動 {#flow-control-activities}
      + [關於流程控制活動 - 隱藏](workflow/using/about-flow-control-activities.md)
      + [開始和結束 - 隱藏](workflow/using/start-and-end.md)
      + [分支 - 隱藏](workflow/using/fork.md)
      + [合併聯結 - 隱藏](workflow/using/and-join.md)
      + [排程器 - 隱藏](workflow/using/scheduler.md)
      + [測試 - 隱藏](workflow/using/test.md)
      + [等待 - 隱藏](workflow/using/wait.md)
      + [時間限制 - 隱藏](workflow/using/time-constraint.md)
      + [子工作流程 - 隱藏](workflow/using/sub-workflow.md)
      + [跳轉 (起點和終點 - 隱藏)](workflow/using/jump-start-point-and-end-point.md)
      + [外部訊號 - 隱藏](workflow/using/external-signal.md)
      + [核准 - 隱藏](workflow/using/approval.md)
      + [警報 - 隱藏](workflow/using/alert.md)
      + [任務 - 隱藏](workflow/using/task.md)
   + 動作活動 {#action-activities}
      + [關於動作活動 - 隱藏](workflow/using/about-action-activities.md)
      + [傳遞 - 隱藏](workflow/using/delivery.md)
      + [傳遞控制 - 隱藏](workflow/using/delivery-control.md)
      + [持續傳遞 - 隱藏](workflow/using/continuous-delivery.md)
      + [定期傳遞 - 隱藏](workflow/using/recurring-delivery.md)
      + [跨頻道傳遞 - 隱藏](workflow/using/cross-channel-deliveries.md)
      + [本地核准 - 隱藏](workflow/using/local-approval.md)
      + [資料載入中 (RDBMS) - 隱藏](workflow/using/data-loading-rdbms.md)
      + [載入中 (SOAP) - 隱藏](workflow/using/loading-soap.md)
      + [資料載入中 (檔案) - 隱藏](workflow/using/data-loading-file.md)
      + [內容管理 - 隱藏](workflow/using/content-management.md)
      + [資料擷取 (檔案) - 隱藏](workflow/using/extraction-file.md)
      + [SQL 程式碼和 JavaScript 程式碼 - 隱藏](workflow/using/sql-code-and-javascript-code.md)
      + [SQL 資料管理 - 隱藏](workflow/using/sql-data-management.md)
      + [Nlserver 模組 - 隱藏](workflow/using/nlserver-module.md)
      + [更新彙總 - 隱藏](workflow/using/update-aggregate.md)
   + 事件活動 {#event-activities}
      + [關於事件活動 - 隱藏](workflow/using/about-event-activities.md)
      + [檔案收集器 - 隱藏](workflow/using/file-collector.md)
      + [檔案傳輸 - 隱藏](workflow/using/file-transfer.md)
      + [網頁下載 - 隱藏](workflow/using/web-download.md)
      + [傳入電子郵件 - 隱藏](workflow/using/inbound-emails.md)
      + [傳入簡訊 - 隱藏](workflow/using/inbound-sms.md)
   + 使用案例 {#use-cases}
      + [關於工作流程使用案例 - 隱藏](workflow/using/about-workflow-use-cases.md)
      + 傳遞 {#deliveries}
         + [使用本地核准活動 - 隱藏](workflow/using/using-the-local-approval-activity.md)
         + [傳送生日電子郵件 - 隱藏](workflow/using/sending-a-birthday-email.md)
         + [載入傳遞內容 - 隱藏](workflow/using/loading-delivery-content.md)
         + [跨頻道傳遞工作流程 - 隱藏](workflow/using/cross-channel-delivery-workflow.md)
         + [使用自訂日期欄位擴充電子郵件 - 隱藏](workflow/using/email-enrichment-with-custom-date-fields.md)
   + 監視 {#monitoring}
      + [傳送報吿至清單 - 隱藏](workflow/using/sending-a-report-to-a-list.md)
      + [監督您的工作流程 - 隱藏](workflow/using/supervising-workflows.md)
      + [傳送個人化警示給營運商 - 隱藏](workflow/using/sending-personalized-alerts-to-operators.md)
   + 資料管理 {#data-management}
      + [協調資料更新 - 隱藏](workflow/using/coordinating-data-updates.md)
      + [建立摘要清單 - 隱藏](workflow/using/creating-a-summary-list.md)
      + [豐富資料 - 隱藏](workflow/using/enriching-data.md)
      + [使用彙總 - 隱藏](workflow/using/using-aggregates.md)
      + [使用重複資料刪除活動的合併功能 - 隱藏](workflow/using/deduplication-merge.md)
      + [設定週期性匯入工作流程 - 隱藏](workflow/using/recurring-import-workflow.md)
   + 設計查詢 {#designing-queries}
      + [使用增量查詢更新每季清單 - 隱藏](workflow/using/quarterly-list-update.md)
   + 查詢和篩選 {#query-and-filter-hidden}
      + [查詢收件者表格 - 隱藏](workflow/using/querying-recipient-table.md)
      + [查詢傳遞資訊 - 隱藏](workflow/using/querying-delivery-information.md)
      + [執行彙總運算 - 隱藏](workflow/using/performing-aggregate-computing.md)
      + [使用分組管理進行查詢 - 隱藏](workflow/using/querying-using-grouping-management.md)
      + [使用多對多關係進行查詢 - 隱藏](workflow/using/querying-using-many-to-many-relationship.md)
      + [新增分項清單類型計算欄位 - 隱藏](workflow/using/adding-enumeration-type-calculated-field.md)
      + [建立篩選器 - 隱藏](workflow/using/creating-a-filter.md)
      + [篩選重複的收件者 - 隱藏](workflow/using/filtering-duplicated-recipients.md)
   + 監視工作流程 {#monitoring-workflows}
      + [監視工作流程的執行 - 隱藏](workflow/using/monitoring-workflow-execution.md)
      + [監視技術工作流程 - 隱藏](workflow/using/monitoring-technical-workflows.md)
      + [工作流程熱度圖 - 隱藏](workflow/using/heatmap.md)
   + 進階管理 {#advanced-management}
      + [工作流程屬性 - 隱藏](workflow/using/workflow-properties.md)
      + [進階參數 - 隱藏](workflow/using/advanced-parameters.md)
      + [JavaScript 指令碼和範本 - 隱藏](workflow/using/javascript-scripts-and-templates.md)
      + [工作流程中的 JavaScript 程式碼範例 - 隱藏](workflow/using/javascript-in-workflows.md)
      + [存取外部資料庫 - 隱藏](workflow/using/accessing-an-external-database-fda.md)
      + [管理權限 - 隱藏](workflow/using/managing-rights.md)
      + [變更活動影像 - 隱藏](workflow/using/managing-activity-images.md)
      + [管理時區 - 隱藏](workflow/using/managing-time-zones.md)
      + [技術工作流程 - 隱藏](workflow/using/about-technical-workflows.md)
