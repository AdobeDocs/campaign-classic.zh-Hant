  ...
  <td>
   ...
   <td>
    <a href="use-templates.md">
      <img alt="範本" src="assets/do-not-localize/design.svg"/>
    </a>
    <div>
      <a href="use-templates.md">
    <strong>使用範本</strong>
...
<tr>
  <td>
    <a href="define-the-right-audience.md">
      <img alt="目標" src="assets/do-not-localize/profiles.svg"/>
    </a>
    <div>
      <a href="define-the-right-audience.md">
   ...
   <td>
    <a href="check-before-sending.md">
      <img alt="檢查" src="assets/do-not-localize/start.svg"/>
    </a>
    <div>
      <a href="check-before-sending.md">
...
* [安全性與隱私權檢查清單](https://helpx.adobe.com/campaign/kb/acc-security.html)
