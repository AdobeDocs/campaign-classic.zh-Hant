...
>
>本節將介紹如何擴展種子地址表的示例： [使用案例： 選擇條件中的種子地址](../../delivery/using/use-case--selecting-seed-addresses-on-criteria.md)
...
>* 如果提取了元素集合，則這些欄位的種子地址將具有空值，除非選 **[!UICONTROL Single row (expert user)]** 擇了該選項。 如需詳細資訊，請參閱[本章節](../../platform/using/exporting-data.md#step-7---data-formatting)。
>
