...
>
>此頁面記錄混合式部署和內部部署的&#x200B;**Campaign Classic v7專屬自訂**。

監控您的傳送至關重要，以確保您的行銷活動有效並觸及客戶。

如需使用傳送控制面板標籤存取傳送清單及監控傳送的完整資訊，請參閱Campaign UI檔案中的[Campaign v8監控傳送](https://experienceleague.adobe.com/en/docs/campaign/campaign-v8/send/monitor/delivery-dashboard){target="_blank"}。
...
* [退回郵件設定](understanding-delivery-failures.md) （v7混合式/內部部署）
