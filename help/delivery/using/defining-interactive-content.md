...
>[!NOTE]
>
> 對於混合式架構和託管式架構，套件必須安裝在所有伺服器上，包括[中間來源伺服器](../../installation/using/mid-sourcing-server.md)和[執行執行個體](../../message-center/using/configuring-instances.md#execution-instance)。
...
1. 安裝&#x200B;**[!UICONTROL AMP support]**&#x200B;封裝。 請參閱[安裝Campaign內建套件](../../installation/using/installing-campaign-standard-packages.md)。
...
您也可以參閱Gmail[檔案的](https://developers.google.com/gmail/ampemail/tips)提示和已知限制。
