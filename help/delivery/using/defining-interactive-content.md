...
Adobe Campaign可讓您使用新的互動式 [電子郵件AMP](https://amp.dev/about/email/) 格式，可在特定條件下傳送動態電子郵件。
...
在Gmail帳戶上測試使用AMP格式傳送所需的所有步驟和規格，在對應的 [Gmail](https://developers.google.com/gmail/ampemail?), [Outlook ](https://docs.microsoft.com/en-gb/outlook/amphtml/)，和 [Mail.ru](https://postmaster.mail.ru/amp) 開發人員檔案。

特別是，必須滿足以下要求：
* 遵循 [Gmail](https://developers.google.com/gmail/ampemail/security-requirements), [Outlook](https://docs.microsoft.com/en-gb/outlook/amphtml/security-requirements)，和 [Mail.ru](https://postmaster.mail.ru/amp/?lang=en#howto).
...
您也可以參閱 [Gmail的秘訣和已知限制](https://developers.google.com/gmail/ampemail/tips) 和 [Outlook的AMP最佳作法](https://docs.microsoft.com/en-gb/outlook/amphtml/best-practices).
...
只要用幾個地址測試，您就可以傳送AMP電子郵件至任何Gmail或Outlook地址。 若要這麼做，您必須恭敬地向Google或Microsoft註冊，並等待他們的回答。 請依照 [Gmail](https://developers.google.com/gmail/ampemail/register) 和 [Outlook](https://docs.microsoft.com/en-gb/outlook/amphtml/register-outlook#global-registration) 開發人員檔案。 註冊成功後，您會成為授權寄件者。
