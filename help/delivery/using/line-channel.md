...
建立之前 [!DNL LINE] 帳戶和外部帳戶，您必須先在執行個體上安裝LINE套件。 如需詳細資訊，請參閱 [本節](../../installation/using/installing-campaign-standard-packages.md#line-package).
