...
1. As an option, you can enrich a push message content with some **[!UICONTROL Application variables]** if needed. 這些功能可完全自訂，且是傳送至行動裝置之訊息裝載的一部分。

1. 按一下 **[!UICONTROL Finish]**，之後 **[!UICONTROL Save]**。Your Android application is now ready to be used in Campaign Classic.
...
|:-:|:-:|:-:|
| 資料訊息 | 不適用 | dryRun |
| 通知訊息 | title, body, android_channel_id, icon, sound, tag, color, click_action <br> | dryRun |
