...
>[!NOTE]
>
>若要瞭解如何針對iOS設定您的應用程式，以及如何為iOS建立傳遞，請參閱此 [區段](configuring-the-mobile-application.md).
...
建立服務和新的行動應用程式後，您需要根據所選的API版本設定行動應用程式。
...
|:-:|:-:|:-:|
| 資料訊息 | N/A | 練習版 |
| 通知訊息 | title， body， android_channel_id， icon， sound， tag， color， click_action <br> | 練習版 |
