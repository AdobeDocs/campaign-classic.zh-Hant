...
若要在Campaign UI中監視傳遞，請參閱Campaign UI檔案[中的](https://experienceleague.adobe.com/en/docs/campaign/campaign-v8/send/monitor/delivery-dashboard){target="_blank"}Campaign v8監視傳遞。
