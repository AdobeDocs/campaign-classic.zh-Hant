...
# 傳遞失敗與隔離管理 {#delivery-failures-quarantine}
...
如需詳細資訊，請參閱&#x200B;**傳送傳遞** > **設定重試**&#x200B;下的[此頁面](communication-channels.md)。
...
* 30天後出現&#x200B;**[!UICONTROL Mailbox full]**&#x200B;錯誤且處於&#x200B;**[!UICONTROL With errors]**&#x200B;狀態的地址
