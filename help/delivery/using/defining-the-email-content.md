...
description: 了解使用Adobe Campaign時如何定義電子郵件內容
...
根據收件者偏好設定，預設會以HTML或文字格式傳送訊息。 建議您以兩種格式建立內容，以確保郵件可以正確顯示在任何郵件系統中。 有關詳細資訊，請參閱 [選擇消息格式](email-parameters.md#selecting-message-formats).
